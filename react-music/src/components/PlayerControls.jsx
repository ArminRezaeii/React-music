...
export default function PlayerControls() {
    const [{ playerstate, token }] = useStateProvider()
    const changeTrack = async (type) => {
        ...
        if (response.data !== "") {
            ...
            disptach({ type: reducerCases.SET_PLAYING, currentlyPlaying: null })
        }
    }
    const changeState = async () => {
        ...
        disptach({ type: reducerCases.SET_PLAYING, playerstate: !playerstate })
    }
